...
public final class AssetTransfer implements ContractInterface {
    ...
    /**
     * Duplicates an asset and assigns the duplicate to a new owner while keeping the original asset with the previous original owner.
     * @param ctx
     * @param assetID
     * @param newOwner
    ...
    public Asset DuplicateAsset(final Context ctx, final String assetID, final String newOwner) {
        ...
        Asset asset = genson.deserialize(assetJSON, Asset.class);
        // New assetID is derived from the original ID by appending the suffix '_dup_<newOwner>'
        // This allows the same asset to be duplicated to multiple owners
        // while preventing duplicating the same asset multiple times to the same owner
        String newAssetID = String.format("%s_dup_%s", assetID, newOwner);
